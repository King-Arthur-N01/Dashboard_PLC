 ...
 * v3.0.4 - https://unpkg.com/canvg@3.0.4/lib/umd.js
 * MIT Licensed
...
(function (e, t) {
    ...
    function L(t) {
        ...
        if ((co === V || !co) && setTimeout)
            return (co = setTimeout), setTimeout(t, 0);
        try {
            return co(t, 0);
        } catch (n) {
            try {
    ...
    function I(t) {
        ...
        if ((po === R || !po) && clearTimeout)
            return (po = clearTimeout), clearTimeout(t);
        try {
            return po(t);
        } catch (n) {
            try {
    ...
    function D() {
        ho &&
            mo &&
            ((ho = !1),
            mo.length ? (yo = mo.concat(yo)) : (fo = -1),
            yo.length && N());
    }
    function N() {
        if (!ho) {
    ...
    function re(e, t, n, a, r, i) {
        if (!(isNaN(i) || 1 > i)) {
            ...
            var l = ae(e, t, n, a, r);
            (l = ie(l, t, n, a, r, i)),
                e.getContext("2d").putImageData(l, t, n);
        }
    }
    function ie(e, t, n, a, r, l) {
        ...
        for (m = 0; m < r; m++) {
            for (
                ...
                (h.r = M), (h.g = z), (h.b = B), (h.a = _), (h = h.next);
            for (b = 1; b < u; b++)
                (v = S + ((s < b ? s : b) << 2)),
                    (A += (h.r = M = o[v]) * (F = u - b)),
                    (E += (h.g = z = o[v + 1]) * F),
    ...
    var Ee =
        ...
        Ge = function (e, t) {
            ...
            if (
                ...
                return a;
            if ("function" == typeof (n = e.valueOf) && !je((a = n.call(e))))
                return a;
            if (
                !t &&
                "function" == typeof (n = e.toString) &&
    ...
    var wt = {
        ...
        Ot = t(function (e) {
            ...
            (e.exports = function (e, t, r, i) {
                ...
                return ("function" == typeof r &&
                    ("string" == typeof t && !Ye(r, "name") && nt(r, "name", t),
                    (n(r).source = a.join("string" == typeof t ? t : ""))),
                e === Ce)
                    ? void (o ? (e[t] = r) : at(t, r))
                    : void (l ? !s && e[t] && (o = !0) : delete e[t],
                      o ? (e[t] = r) : nt(e, t, r));
            })(Function.prototype, "toString", function () {
                return (
                    ("function" == typeof this && t(this).source) || st(this)
                );
            });
        }),
        Vt = Ce,
        ...
        Wt = function (e, t) {
            for (var n = Ut(t), a = tt.f, r = Ke.f, l = 0, o; l < n.length; l++)
                (o = n[l]), Ye(e, o) || a(e, o, r(t, o));
        },
        qt = /#|\.prototype\./,
        Xt = function (e, t) {
            var n = Kt[Qt(e)];
            return (
                n == Jt || (n != Zt && ("function" == typeof t ? we(t) : !!t))
            );
        },
            ...
            if (
                ...
                for (o in t) {
                    if (
                        ((d = t[o]),
                        e.noTargetGet
                            ? ((u = tn(l, o)), (s = u && u.value))
                            : (s = l[o]),
                        (i = en(a ? o : n + (r ? "." : "#") + o, e.forced)),
                        !i && void 0 !== s)
                    ) {
                        if (typeof d == typeof s) continue;
                        Wt(d, s);
                    }
                    (e.sham || (s && s.sham)) && nt(d, "sham", !0),
                        Ot(l, o, d, e);
                }
        },
        an = function (e) {
        ...
        hn = function (e, t) {
            ...
            return (
                on(e) &&
                    ((n = e.constructor),
                    "function" == typeof n && (n === Array || on(n.prototype))
                        ? (n = void 0)
                        : je(n) && ((n = n[yn]), null === n && (n = void 0))),
        ...
        An;
    Sn
        ? ((Pn = Sn.split(".")), (An = Pn[0] + Pn[1]))
        : bn &&
          ((Pn = bn.match(/Edge\/(\d+)/)),
          (!Pn || 74 <= Pn[1]) &&
              ((Pn = bn.match(/Chrome\/(\d+)/)), Pn && (An = Pn[1])));
    var En = An && +An,
        Tn = pn("species"),
        Cn = function (e) {
            return (
    ...
    nn(
        { target: "Array", proto: !0, forced: !On || !Vn },
        {
            map: function (e) {
                return wn(
                    this,
    ...
    var Rn =
        ...
        Nn = { start: Dn(1), end: Dn(2), trim: Dn(3) },
        Mn = Nn.trim,
        zn = Ce.parseFloat,
        Bn =
            1 /
        ...
        _n = Bn
            ...
            : zn;
    nn({ global: !0, forced: parseFloat != _n }, { parseFloat: _n });
    var Fn = function () {
            var e = Ze(this),
                t = "";
            return (
        ...
        Hn = { UNSUPPORTED_Y: jn, BROKEN_CARET: Gn },
        ...
        (Un = function (e) {
            ...
            return (
                n &&
                    ((a = a.replace("y", "")),
                    -1 === a.indexOf("g") && (a += "g"),
                    (o = (e + "").slice(t.lastIndex)),
                    0 < t.lastIndex &&
                        (!t.multiline ||
                            (t.multiline && "\n" !== e[t.lastIndex - 1])) &&
                        ((r = "(?: " + r + ")"), (o = " " + o), l++),
                    (d = new RegExp("^(?:" + r + ")", a))),
                Xn && (d = new RegExp("^" + r + "$(?!\\s)", a)),
                Wn && (s = t.lastIndex),
                (u = Yn.call(n ? d : t, o)),
                n
                    ? u
                        ? ((u.input = u.input.slice(l)),
                          (u[0] = u[0].slice(l)),
                          (u.index = t.lastIndex),
                    ...
                    : Wn &&
                      u &&
                      (t.lastIndex = t.global ? u.index + u[0].length : s),
                Xn &&
                    u &&
                    1 < u.length &&
                    $n.call(u[0], d, function () {
                        for (g = 1; g < arguments.length - 2; g++)
                            void 0 === arguments[g] && (u[g] = void 0);
                    }),
                u
            );
        });
    var Qn = Un;
    nn({ target: "RegExp", proto: !0, forced: /./.exec !== Qn }, { exec: Qn });
    var Kn = pn("species"),
        Zn = !we(function () {
            var e = /./;
            return (
                ...
                var o = /./[r],
                    s = n(
                        ...
                        function (e, t, n, a, r) {
                            return t.exec === Qn
                                ? i && !r
                                    ? { done: !0, value: o.call(t, n, a) }
                                    : { done: !0, value: e.call(n, t, a) }
                                : { done: !1 };
                        },
                        { REPLACE_KEEPS_$0: Jn }
                    ),
                ...
                return 0 > r || r >= i
                    ...
                    : ((l = a.charCodeAt(r)),
                      ...
                      57343 < o
                          ...
                          : e
                          ? a.slice(r, r + 2)
                          : ((l - 55296) << 10) + (o - 56320) + 65536);
            };
        },
        aa = { codeAt: na(!1), charAt: na(!0) },
        ra = aa.charAt,
        ia = function (e, t, n) {
    ...
    ta("match", 1, function (e, t, a) {
        return [
            ...
            function (e) {
                ...
                var o = i.unicode;
                i.lastIndex = 0;
                for (var s = [], d = 0, u, g; null !== (u = la(i, l)); )
                    (g = u[0] + ""),
                        (s[d] = g),
                        "" == g && (i.lastIndex = ia(l, Dt(i.lastIndex), o)),
                        d++;
                return 0 === d ? null : s;
            },
        ];
    ...
    ta("replace", 2, function (e, t, n, a) {
        function r(e, a, r, i, l, o) {
            var s = r + e.length,
                ...
                n = sa;
            return (
                void 0 !== l && ((l = ln(l)), (n = oa)),
                t.call(o, n, function (t, o) {
                    var u;
                    switch (o.charAt(0)) {
                        case "$":
                            return "$";
        ...
        return [
            ...
            function (e, l) {
                ...
                for (
                    var p = [], y, h;
                    ((y = la(s, d)), null !== y) && (p.push(y), !!g);

                )
                    (h = y[0] + ""),
                        "" == h && (s.lastIndex = ia(d, Dt(s.lastIndex), c));
                for (var f = "", m = 0, x = 0; x < p.length; x++) {
                    y = p[x];
                    for (
                        var b = y[0] + "",
                            v = me(xe(It(y.index), d.length), 0),
                            k = [],
                            S = 1;
                        S < y.length;
                        S++
    ...
    var ua = /^[A-Z-]+$/,
        ...
        ya = ga("join", ",");
    nn(
        { target: "Array", proto: !0, forced: pa || ya },
        {
            join: function (e) {
    ...
    var ha = function (e) {
        ...
        wa = Oe
            ...
            : function (e, t) {
                  Ze(e);
                  for (var n = Ca(t), a = n.length, r = 0, i; a > r; )
                      tt.f(e, (i = n[r++]), t[i]);
                  return e;
              },
    ...
    var ja =
        ...
        Ua = {
            f: function (e) {
                return Ya && "[object Window]" == Ha.call(e)
                    ? $a(e)
                    : Ga(Fe(e));
            },
        },
        ...
        Xa = function (e) {
            ...
            Ye(t, e) || qa(t, e, { value: Wa.f(e) });
        },
        Qa = tt.f,
        Ka = pn("toStringTag"),
        Za = function (e, t, n) {
            e &&
                !Ye((e = n ? e : e.prototype), Ka) &&
                Qa(e, Ka, { configurable: !0, value: t });
        },
        Ja = xn.forEach,
        er = ft("hidden"),
        tr = "Symbol",
        ...
        kr = function (e, t) {
            var n = (pr[e] = ja(or[nr]));
            return (
                rr(n, { type: tr, tag: e, description: t }),
                Oe || (n.description = t),
                n
            );
        },
        ...
        Pr = function (e, t, n) {
            ...
            return (
                ...
                Ye(pr, a)
                    ? (n.enumerable
                          ? (Ye(e, er) && e[er][a] && (e[er][a] = !1),
                            (n = ja(n, { enumerable: De(0, !1) })))
                          : (!Ye(e, er) && ur(e, er, De(1, {})),
                            (e[er][a] = !0)),
                      vr(e, a, n))
                    : ur(e, a, n)
            );
        ...
        Er = function (e) {
            var t = Ge(e, !0),
                n = cr.call(this, t);
            return (
                (this !== lr || !Ye(pr, t) || Ye(yr, t)) &&
                (!(
                    n ||
                    !Ye(this, t) ||
                    !Ye(pr, t) ||
                    (Ye(this, er) && this[er][t])
                ) ||
                    n)
            );
        },
    ...
    if (
        (sn ||
            ((or = function () {
                ...
                return (
                    Oe && br && vr(lr, t, { configurable: !0, set: n }),
                    kr(t, e)
                );
            }),
            ...
            Oe &&
                (ur(or[nr], "description", {
                    configurable: !0,
                    get: function () {
                        return ir(this).description;
                    },
                }),
                Ot(lr, "propertyIsEnumerable", Er, { unsafe: !0 }))),
        nn({ global: !0, wrap: !0, forced: !sn, sham: !sn }, { Symbol: or }),
        Ja(Ca(mr), function (e) {
            Xa(e);
        }),
        nn(
            { target: tr, stat: !0, forced: !sn },
            {
                for: function (e) {
                    var t = e + "";
        ...
        nn(
            { target: "Object", stat: !0, forced: !sn, sham: !Oe },
            {
                create: function (e, t) {
        ...
        nn(
            { target: "Object", stat: !0, forced: !sn },
            { getOwnPropertyNames: Cr, getOwnPropertySymbols: wr }
        ),
        nn(
            {
                target: "Object",
        ...
        nn(
            { target: "JSON", stat: !0, forced: Or },
            {
                stringify: function (e, t) {
                    for (var n = [e], a = 1, r; arguments.length > a; )
                        n.push(arguments[a++]);
                    if (((r = t), (je(t) || void 0 !== e) && !Sr(e)))
                        return (
                            on(t) ||
                                (t = function (e, t) {
                                    if (
    ...
    nn(
        { target: "Array", proto: !0, forced: !Rr || !Lr },
        {
            filter: function (e) {
                return Vr(
                    this,
    ...
    var Ir = xn.forEach,
        Dr = ga("forEach")
            ...
            : [].forEach;
    nn(
        { target: "Array", proto: !0, forced: [].forEach != Dr },
        { forEach: Dr }
    ),
        nn(
            { target: "Object", stat: !0, forced: !Oe, sham: !Oe },
            { defineProperties: wa }
        ),
        nn(
            { target: "Object", stat: !0, forced: !Oe, sham: !Oe },
    ...
    nn(
        { target: "Object", stat: !0, forced: !Oe || Mr, sham: !Oe },
        {
    ...
    nn(
        { target: "Object", stat: !0, sham: !Oe },
        {
            getOwnPropertyDescriptors: function (e) {
                for (
                    var t = Fe(e), n = Ke.f, a = Ut(t), r = {}, i = 0, l, o;
                    a.length > i;

                )
                    (o = n(t, (l = a[i++]))), void 0 !== o && zr(r, l, o);
                return r;
            },
        }
    );
    ...
    nn(
        { target: "Object", stat: !0, forced: Br },
        {
            keys: function (e) {
                return Ca(ln(e));
            },
    ...
    var Hr = t(function (e) {
            var t = (function (e) {
                ...
                return (
                    (r.prototype = T.constructor = i),
                    (i.constructor = r),
                    (i[v] = r.displayName = "GeneratorFunction"),
                    ...
                    (c.prototype = {
                        ...
                        dispatchException: function (e) {
                            function t(t, a) {
                                return (
                                    ...
                                    (l.arg = e),
                                    (n.next = t),
                                    a && ((n.method = "next"), (n.arg = k)),
                                    !!a
                                );
                            }
                            if (this.done) throw e;
                            for (
                                var n = this, a = this.tryEntries.length - 1;
                                0 <= a;
                                --a
                            ) {
                                ...
                                if (r.tryLoc <= this.prev) {
                                    ...
                                    else if (this.prev < r.finallyLoc)
                                        return t(r.finallyLoc);
                                }
                            }
                        },
                        abrupt: function (e, t) {
                            for (
                                var n = this.tryEntries.length - 1, a;
                                0 <= n;
                                --n
                            )
                                if (
                        ...
                        finish: function (e) {
                            for (
                                var t = this.tryEntries.length - 1, n;
                                0 <= t;
                                --t
                            )
                                if (
                            ...
                            for (
                                ...
                                if (
                                    ((n = this.tryEntries[t]), n.tryLoc === e)
                                ) {
                                    var a = n.completion;
                                    if ("throw" === a.type) {
                                        var r = a.arg;
    ...
    var ti = xn.every;
    nn(
        { target: "Array", proto: !0, forced: ga("every") },
        {
            every: function (e) {
                return ti(
                    this,
    ...
    var ni = function (e) {
            return function (t, n, a, r) {
                ...
                for (; e ? 0 <= d : s > d; d += u)
                    d in o && (r = n(r, o[d], d, l));
                return r;
            };
        },
        ai = { left: ni(!1), right: ni(!0) },
        ri = ai.left;
    nn(
        { target: "Array", proto: !0, forced: ga("reduce") },
        {
            reduce: function (e) {
                return ri(
                    this,
    ...
    var ci = "[object z]" === gi + "",
        ...
        hi = function (e, t) {
            ...
            return void 0 === e
                ...
                : null === e
                ? "Null"
                : "string" == typeof (n = hi((t = Object(e)), pi))
                ? n
                : yi
                ? Me(t)
                : "Object" == (a = Me(t)) && "function" == typeof t.callee
                ? "Arguments"
                : a;
        },
        mi = function () {
    ...
    ci || Ot(Object.prototype, "toString", mi, { unsafe: !0 });
    var xi = Ce.Promise,
        bi = function (e, t, n) {
            ...
            var t = function (e, t) {
                ...
                n = (e.exports = function (e, n, a, r, i) {
                    ...
                    for (c = o.next; !(p = c.call(o)).done; )
                        if (
                            ((g = Oi(o, l, p.value, r)),
                            "object" == typeof g && g && g instanceof t)
                        )
                            return g;
                    return new t(!1);
                });
    ...
    (Fi && ji) ||
        ...
        "process" == Me(Gi)
            ...
            ? ((Ji = new Hi()),
              (el = Ji.port2),
              (Ji.port1.onmessage = Qi),
              (Zi = rn(el.postMessage, el, 1)))
            : !Ce.addEventListener ||
    ...
    dl ||
        ...
        ol
            ...
            : rl && !Bi
            ? ((yl = !0),
              (hl = document.createTextNode("")),
              new rl(ul).observe(hl, { characterData: !0 }),
              (pl = function () {
                  hl.data = yl = !yl;
              }))
            : ll && ll.resolve
            ? ((fl = ll.resolve(void 0)),
              (ml = fl.then),
              (pl = function () {
                  ml.call(fl, ul);
              }))
    ...
    var xl =
        ...
        Yl = en(Tl, function () {
            ...
            if (!e) {
                if (66 === En) return !0;
                if (!zl && "function" != typeof PromiseRejectionEvent)
                    return !0;
            }
        ...
        Wl = function (e, t, n) {
            if (!t.notified) {
                ...
                xl(function () {
                    for (
                        var r = t.value, i = t.state == jl, l = 0;
                        a.length > l;
        ...
        ql = function (e, t, n) {
            ...
            Bl
                ...
                (r = Ce["on" + e])
                    ? r(a)
                    : e === _l && Sl("Unhandled promise rejection", n);
        },
        Xl = function (e, t) {
            Al.call(Ce, function () {
                var n = t.value,
        ...
        Kl = function (e, t) {
            Al.call(Ce, function () {
                zl
                    ? Il.emit("rejectionHandled", e)
                    : ql("rejectionhandled", e, t.value);
            });
        },
        Zl = function (e, t, n, a) {
            return function (r) {
    ...
    Yl &&
        ...
        (to.prototype = bi(Vl.prototype, {
            then: function (e, t) {
                ...
                return (
                    ...
                    (a.domain = zl ? Il.domain : void 0),
                    (n.parent = !0),
                    n.reactions.push(a),
                    n.state != Fl && Wl(this, n, !1),
                    a.promise
                );
            },
            catch: function (e) {
        ...
        (no = function () {
            var e = new to(),
                t = Cl(e);
            (this.promise = e),
                (this.resolve = Zl(eo, e, t)),
                (this.reject = Zl(Jl, e, t));
        }),
        (vl.f = Nl =
            function (e) {
        ...
        nn({ global: !0, wrap: !0, forced: Yl }, { Promise: Vl }),
        Za(Vl, Tl, !1),
        ki(Tl),
        (ao = Lt(Tl)),
        nn(
            { target: Tl, stat: !0, forced: Yl },
            {
                reject: function (e) {
                    var t = Nl(this);
                    ...
                    "".split(/.?/).length
                        ? function (e, n) {
                              ...
                              for (
                                  ...
                                  !(
                                      u > o &&
                                      (i.push(a.slice(o, d.index)),
                                      1 < d.length &&
                                          d.index < a.length &&
                                          oo.apply(i, d.slice(1)),
                                      (g = d[0].length),
                                      (o = u),
                                      i.length >= r)
                                  ));
                    ...
                    function (r, l) {
                        ...
                        for (var f = 0, m = 0, x = []; m < d.length; ) {
                            ...
                            if (
                                null === b ||
                                (v = xe(
                                    Dt(y.lastIndex + (uo ? 0 : m)),
                                    d.length
                                )) === f
                            )
                                m = ia(d, m, g);
                            else {
                                if ((x.push(d.slice(f, m)), x.length === h))
                                    return x;
                                for (var k = 1; k <= b.length - 1; k++)
                                    if ((x.push(b[k]), x.length === h))
                                        return x;
                                m = f = v;
                            }
                        }
    ...
    var go =
        ...
        co = V,
        po = R;
    "function" == typeof go.setTimeout && (co = setTimeout),
        "function" == typeof go.clearTimeout && (po = clearTimeout);
    var yo = [],
        ho = !1,
        fo = -1,
        mo;
    ...
    for (
        var xo = {},
            ...
            Co = t(function (e) {
                (function () {
                    ...
                    performance.now
                        ...
                        : "undefined" != typeof To && null !== To && To.hrtime
                        ? ((e.exports = function () {
                              return (t() - i) / 1e6;
                          }),
                          (n = To.hrtime),
            ...
            wo = "undefined" == typeof window ? Ee : window,
            Oo = ["moz", "webkit"],
            Vo = "AnimationFrame",
            Ro = wo["request" + Vo],
            Lo = wo["cancel" + Vo] || wo["cancelRequest" + Vo],
            Io = 0;
        !Ro && Io < Oo.length;
        Io++
    )
        (Ro = wo[Oo[Io] + "Request" + Vo]),
            (Lo =
                wo[Oo[Io] + "Cancel" + Vo] ||
                wo[Oo[Io] + "CancelRequest" + Vo]);
    if (!Ro || !Lo) {
        var Do = 0,
            No = 0,
            Mo = [];
        (Ro = function (e) {
            ...
            return Mo.push({ handle: ++No, callback: e, cancelled: !1 }), No;
        }),
            (Lo = function (e) {
                for (var t = 0; t < Mo.length; t++)
                    Mo[t].handle === e && (Mo[t].cancelled = !0);
            });
    }
    var zo = function (e) {
            return Ro.call(wo, e);
            ...
            for (
                ...
                if (o) {
                    ...
                    (this.r = s[0]),
                        (this.g = s[1]),
                        (this.b = s[2]),
                        3 < s.length && (this.alpha = s[3]),
                        (this.ok = !0);
                }
            }
            (this.r =
                0 > this.r || isNaN(this.r) ? 0 : 255 < this.r ? 255 : this.r),
                (this.g =
                    0 > this.g || isNaN(this.g)
                        ? 0
                        : 255 < this.g
                        ? 255
                        : this.g),
                (this.b =
                    0 > this.b || isNaN(this.b)
                        ? 0
                        : 255 < this.b
                        ? 255
                        : this.b),
                    ...
                    for (var a = 0; a < e.length; a++)
                        try {
                            ...
                            (g.style.cssText =
                                ...
                                "; color:" +
                                u.toHex()),
                                g.appendChild(document.createTextNode("test"));
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                switch (!0) {
                                    ...
                                    case this.isString(/%$/):
                                        return (
                                            this.getNumber() * o.computeSize(i)
                                        );
                                    default: {
                            ...
                            value: function (e, t) {
                                ...
                                if ("function" == typeof n.createPattern) {
                                    if (n.getHrefAttribute().hasValue()) {
                                        var a =
                                            n.getAttribute("patternTransform");
                                        (n = n
                                            .getHrefAttribute()
                                            .getDefinition()),
                                            a.hasValue() &&
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            return "number" == typeof e
                                ...
                                : "y" === e
                                ? this.height
                                : Pe(Ae(this.width, 2) + Ae(this.height, 2)) /
                                  Pe(2);
                        },
                    },
                    {
                ...
                qr(
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                for (
                                    var n = o(t), a = n.length, r = [], l = 0;
                                    l < a;
                                    l += 2
                                )
                                    r.push(new e(n[l], n[l + 1]));
                                return r;
                            },
                        },
                    ]
                        ...
                        value: function (e, t) {
                            for (
                                ...
                                (i.x -= l.offsetLeft),
                                    ...
                                    (l = l.offsetParent);
                            return (
                                a.scrollX && (i.x += a.scrollX),
                                a.scrollY && (i.y += a.scrollY),
                                i
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (!N) {
                                ...
                                /^xMid/.test(E) &&
                                    (B || _) &&
                                    n.translate(i / 2 - R / 2, 0),
                                    /YMid$/.test(E) &&
                                        (F || j) &&
                                        n.translate(0, o / 2 - L / 2),
                                    /^xMax/.test(E) &&
                                        (B || _) &&
                                        n.translate(i - R, 0),
                                    /YMax$/.test(E) &&
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            var t = this,
                                ...
                                m = 1e3 / h;
                            if (
                                ((this.frameDuration = m),
                                (this.readyPromise = new Promise(function (e) {
                                    t.resolveReady = e;
                                })),
                                this.isReady() &&
                                    this.render(e, o, d, g, c, p, y),
                                !!(void 0 !== a && a))
                            ) {
                                var x = Date.now(),
                                    b = x,
                    ...
                    },
                    {
                        ...
                        value: function (e, t, n, a, r, i, l) {
                            ...
                            if (
                                ...
                                u.setCurrent(f, m),
                                "number" == typeof i &&
                                    e.getAttribute("x", !0).setValue(i),
                                "number" == typeof l &&
                                    e.getAttribute("y", !0).setValue(l),
                                ...
                                b || (b = v),
                                    v || (v = b),
                                    e.getAttribute("width", !0).setValue(a),
                                    e.getAttribute("height", !0).setValue(r);
    ...
    var Jo = Zo.defaultFetch,
        ...
        rs = function (e, t) {
            return t && ("object" === ns(t) || "function" == typeof t)
                ? t
                : as(e);
        },
        is = t(function (e) {
        ...
        { target: "Array", stat: !0, forced: ss },
        {
            from: function (e) {
                var t = ln(e),
                    ...
                    c;
                if (
                    (i && (r = rn(r, 2 < a ? arguments[2] : void 0, 2)),
                    null != o && !(n == Array && Ti(o)))
                )
                    for (
                        g = o.call(t), c = g.next, d = new n();
                        !(u = c.call(g)).done;
                        l++
                    )
                        zr(d, l, i ? Oi(g, r, [u.value, l], !0) : u.value);
                else
                    for (s = Dt(t.length), d = new n(s); s > l; l++)
                        zr(d, l, i ? r(t[l], l) : t[l]);
                return (d.length = l), d;
            },
        }
    );
    var ds = pn("unscopables"),
        us = Array.prototype;
    null == us[ds] && tt.f(us, ds, { configurable: !0, value: ja(null) });
    var gs = function (e) {
            us[ds][e] = !0;
        },
        cs = zt.includes;
    ...
    var ps = xn.some;
    nn(
        { target: "Array", proto: !0, forced: ga("some") },
        {
            some: function (e) {
                return ps(
                    this,
    ...
    [].keys &&
        ((As = [].keys()),
        "next" in As
            ? ((Ps = bs(bs(As))), Ps !== Object.prototype && (Ss = Ps))
            : (ks = !0)),
        null == Ss && (Ss = {}),
        Ye(Ss, vs) ||
            nt(Ss, vs, function () {
    ...
    var Es = { IteratorPrototype: Ss, BUGGY_SAFARI_ITERATORS: ks },
        ...
        Bs = function (e, t, n, a, r, i, l) {
            ...
            if (
                (c &&
                    ...
                    Rs !== Object.prototype &&
                        ...
                        (bs(p) !== Rs &&
                            (Vs
                                ? Vs(p, Rs)
                                : "function" != typeof p[Is] && nt(p, Is, zs)),
                        Za(p, t + " Iterator", !0))),
                r == Ns &&
                    u &&
                    u.name !== Ns &&
                ...
                else nn({ target: t, proto: !0, forced: Ls || s }, y);
            return y;
        },
        _s = aa.charAt,
        Fs = "String Iterator",
    ...
    Bs(
        ...
        "String",
        function (e) {
            js(this, { type: Fs, string: e + "", index: 0 });
        },
        function () {
            var e = Gs(this),
                t = e.string,
    ...
    var Ys = (function () {
        function e(t, n) {
            ...
            if (
                ...
                o.hasValue() && !l[o.getValue()] && (l[o.getValue()] = this),
        ...
        return (
            qr(e, [
                    ...
                    value: function (e) {
                        if (
                            ...
                            if ((e.save(), this.getStyle("mask").hasValue())) {
                                ...
                                "none" !==
                                this.getStyle("filter").getValue("none")
                            ) {
                ...
                { key: "clearContext", value: function () {} },
                {
                    key: "renderChildren",
                    value: function (e) {
                ...
                },
                {
                    ...
                    value: function (t) {
                        var n =
                            t instanceof e ? t : this.document.createElement(t);
                        (n.parent = this),
                            e.ignoreChildTypes.includes(n.type) ||
    ...
    var $s = (function (e) {
            function t(e, n, a) {
                ...
                return (
                    Wr(this, t),
                    (r = rs(this, is(t).call(this, e, n, a))),
                    console.warn(
                        "Element ".concat(n.nodeName, " not yet implemented.")
                    ),
                    r
                );
            }
        ...
        Xs = ga("indexOf");
    nn(
        { target: "Array", proto: !0, forced: qs || Xs },
        {
            indexOf: function (e) {
                return qs
                    ? Ws.apply(this, arguments) || 0
                    : Us(this, e, 1 < arguments.length ? arguments[1] : void 0);
            },
        }
    );
    var Qs = [].reverse,
        Ks = [1, 2];
    nn(
        { target: "Array", proto: !0, forced: Ks + "" === Ks.reverse() + "" },
        {
            reverse: function () {
    ...
    var Zs = function (e, t) {
        ...
        ed = (function () {
            function e(t, n, a, r, i, l) {
                ...
                (this.fontFamily = i || o.fontFamily),
                    (this.fontSize = r || o.fontSize),
                    (this.fontStyle = t || o.fontStyle),
                    (this.fontWeight = a || o.fontWeight),
                    (this.fontVariant = n || o.fontVariant);
            }
            return (
                qr(
                    e,
                                    ...
                                    d.forEach(function (t) {
                                        switch (!0) {
                                            case !u.fontStyle &&
                                                ...
                                                break;
                                            case !u.fontVariant &&
                                                e.variants.includes(t):
                                                "inherit" !== t && (i = t),
                                                    (u.fontStyle = !0),
                                                    (u.fontVariant = !0);
                                                break;
                                            case !u.fontWeight &&
                                                e.weights.includes(t):
                                                "inherit" !== t && (l = t),
                                                    (u.fontStyle = !0),
                                                    (u.fontVariant = !0),
                                                    (u.fontWeight = !0);
    ...
    (ed.styles = "normal|italic|oblique|inherit"),
        (ed.variants = "normal|small-caps|inherit"),
        (ed.weights =
    ...
    var td = function (e, t, n) {
        ...
        gd = function (e) {
            ...
            if ("string" == typeof t && 2 < t.length)
                if (
                    ((t = ld(t)), (n = t.charCodeAt(0)), 43 === n || 45 === n)
                ) {
                    if (((a = t.charCodeAt(2)), 88 === a || 120 === a))
                        return NaN;
                } else if (48 === n) {
    ...
    if (en(od, !sd(" 0o1") || !sd("0b1") || sd("+0x1"))) {
        for (
            ...
            Ye(sd, (hd = pd[yd])) && !Ye(cd, hd) && rd(cd, hd, ad(sd, hd));
                ...
                qr(e, [
                    ...
                    },
                    {
                        ...
                        value: function (e, t, n, a, r, i, l, o) {
                            this.addPoint(e, t),
                                this.addPoint(l, o),
                                this.bezierCurveAdd(!0, e, n, r, l),
                                this.bezierCurveAdd(!1, t, a, i, o);
                        },
                    },
                    {
        ...
        Ot(
            ...
            function () {
                var e = Ze(this),
                    ...
                    n = e.flags,
                    a =
                        (void 0 === n && e instanceof RegExp && !("flags" in xd)
                            ? Fn.call(e)
                            : n) + "";
                return "/" + t + "/" + a;
            },
    ...
    var Sd = (function () {
        ...
        Td = (function (e) {
            function t(e, n) {
                ...
                return (
                    Wr(this, t),
                    (a = rs(this, is(t).call(this, e, n))),
                    (a.type = "skew"),
                    (a.angle = null),
                    (a.angle = new Uo(e, "angle", n)),
                    a
                );
            }
            return os(t, e), t;
        ...
        Cd = (function (e) {
            function t(e, n) {
                ...
                return (
                    ...
                    (a = rs(this, is(t).call(this, e, n))),
                    (a.type = "skewX"),
                    (a.matrix = [1, 0, ce(a.angle.getRadians()), 1, 0, 0]),
                    a
                );
            }
            return os(t, e), t;
        ...
        wd = (function (e) {
            function t(e, n) {
                ...
                return (
                    ...
                    (a = rs(this, is(t).call(this, e, n))),
                    (a.type = "skewY"),
                    (a.matrix = [1, ce(a.angle.getRadians()), 0, 1, 0, 0]),
                    a
                );
            }
            return os(t, e), t;
            ...
            function e(t, n, a) {
                ...
                i.forEach(function (t) {
                    if ("none" !== t) {
                        ...
                        "undefined" != typeof s &&
                            r.transforms.push(new s(r.document, o, l));
                    }
                });
            }
            return (
                    ...
                    [
                        {
                            ...
                            value: function (t, n) {
                                ...
                                return a.hasValue()
                                    ? new e(t, a.getString(), r.getString())
                                    : null;
                            },
                        },
                    ]
    ...
    var Vd = (function (e) {
            function t() {
                ...
                return (
                    Wr(this, t),
                    (e = rs(this, is(t).apply(this, arguments))),
                    (e.modifiedEmSizeStack = !1),
                    e
                );
            }
            return (
                ...
                qr(t, [
                    {
                        ...
                        value: function () {
                            for (var e = 1, t = this, n; t; )
                                (n = t.getStyle("opacity", !1, !0)),
                                    n.hasValue() && (e *= n.getNumber()),
                                    (t = t.parent);
                            return e;
                        },
                    },
                            ...
                            if (!t) {
                                ...
                                if (n.isUrlDefinition()) {
                                    ...
                                    "currentColor" === n.getString() &&
                                        n.setValue(
                                            this.getStyle("color").getValue()
                                        );
                                    var s = n.getString();
                                    "inherit" !== s &&
                                        (e.fillStyle =
                                            "none" === s ? "rgba(0,0,0,0)" : s);
                                }
                                if (a.hasValue()) {
                                    var d = new Uo(
                                        this.document,
                                ...
                                if (
                                    (h.hasValue() &&
                                        (e.lineCap = h.getString()),
                                    f.hasValue() &&
                                        (e.lineJoin = f.getString()),
                                    m.hasValue() &&
                                        (e.miterLimit = m.getNumber()),
                                    x.hasValue() &&
                                        (e.paintOrder = x.getValue()),
                                    b.hasValue() && "none" !== b.getString())
                                ) {
                                    var k = o(b.getString());
                                    "undefined" == typeof e.setLineDash
                                        ? "undefined" == typeof e.webkitLineDash
                                            ? "undefined" != typeof e.mozDash &&
                                              (1 !== k.length || 0 !== k[0]) &&
                                              (e.mozDash = k)
                                            : (e.webkitLineDash = k)
                                        : e.setLineDash(k);
                                    var S = v.getPixels();
                                    "undefined" == typeof e.lineDashOffset
                                        ? "undefined" ==
                                          typeof e.webkitLineDashOffset
                                            ? "undefined" !=
                                                  typeof e.mozDashOffset &&
                                              (e.mozDashOffset = S)
                            ...
                            if (
                                ...
                                var P = this.getStyle("font"),
                                    ...
                                    O = new ed(
                                        ...
                                        T.getString(),
                                        C.hasValue()
                                            ? "".concat(C.getPixels(!0), "px")
                                            : "",
                                        w.getString(),
                                        ed.parse(P.getString(), e.font)
                                    );
                                A.setValue(O.fontStyle),
                                    E.setValue(O.fontVariant),
                                    T.setValue(O.fontWeight),
                                    C.setValue(O.fontSize),
                                    w.setValue(O.fontFamily),
                                    (e.font = O.toString()),
                                    C.isPixels() &&
                    ...
                    },
                    {
                        key: "clearContext",
                        value: function (e) {
                            Js(is(t.prototype), "clearContext", this).call(
                                this,
                                e
                            ),
                                this.modifiedEmSizeStack &&
                ...
                qr(t, [
                    {
                        ...
                        value: function (e) {
                            ...
                            Js(is(t.prototype), "setContext", this).call(
                                this,
                                e,
                                n
                            );
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            t.hasValue() && (this.x += t.getPixels("x")),
                                n.hasValue() && (this.y += n.getPixels("y")),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            var n = null;
                            return (
                                this.children.forEach(function (a, r) {
                            ...
                            if (e.isArabic) {
                                ...
                                (0 === n || " " === l) &&
                                    ...
                                    0 < n &&
                                        ...
                                        (n === i - 1 || " " === o) &&
                                        (s = "initial"),
                                    "undefined" != typeof e.glyphs[a] &&
                                        ((r = e.glyphs[a][s]),
                                        !r &&
                                            "glyph" === e.glyphs[a].type &&
                                            (r = e.glyphs[a]));
                            } else r = e.glyphs[a];
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            var t = this;
                            if ("text" !== this.type)
                                return void this.renderTElementChildren(e);
                            this.initializeCoordinates(e),
                                this.children.forEach(function (n, a) {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (r) {
                                for (
                                    var l = r.fontFace.unitsPerEm,
                                        s = ed.parse(t.ctx.font),
                                        d = n
                                            .getStyle("font-size")
                                            .getNumber(s.fontSize),
                                        u = n
                                            .getStyle("font-style")
                                            .getString(s.fontStyle),
                                        g = d / l,
                                        c = r.isRTL
                                            ? a.split("").reverse().join("")
                                            : a,
                                        p = o(n.getAttribute("dx").getString()),
                                        h = c.length,
                                        f = 0,
                                        m;
                                    f < h;
                                    ...
                                    (m = this.getGlyph(r, c, f)),
                                        e.translate(this.x, this.y),
                                        e.scale(g, -g);
                                    var b = e.lineWidth;
                                    (e.lineWidth = (e.lineWidth * l) / d),
                                        "italic" === u &&
                                            e.transform(1, 0, 0.4, 1, 0, 0),
                                        m.render(e),
                                        "italic" === u &&
                                            e.transform(1, 0, -0.4, 1, 0, 0),
                                        (e.lineWidth = b),
                                        ...
                                        e.translate(-this.x, -this.y),
                                        (this.x +=
                                            (d * (m.horizAdvX || r.horizAdvX)) /
                                            l),
                                        "undefined" == typeof p[f] ||
                                            isNaN(p[f]) ||
                                            (this.x += p[f]);
                                }
                                return;
                            ...
                            var v = this.x,
                                x = this.y;
                            "stroke" === e.paintOrder
                                ? (e.strokeStyle && e.strokeText(a, v, x),
                                  e.fillStyle && e.fillText(a, v, x))
                                : (e.fillStyle && e.fillText(a, v, x),
                                  e.strokeStyle && e.strokeText(a, v, x));
                        },
                    },
                        ...
                        value: function (e, t, n) {
                            ...
                            if ("start" !== a) {
                                for (
                                    ...
                                    !(
                                        (d > n &&
                                            o.getAttribute("x").hasValue()) ||
                                        o.getAttribute("text-anchor").hasValue()
                                    ));
                                    d++
                                )
                                    s += o.measureTextRecursive(e);
                        ...
                        value: function (e, t, n, a) {
                            ...
                            if (
                                (0 === a &&
                                    ...
                                    (!i.hasValue() &&
                                        i.setValue(
                                            t.getAttribute("x").getValue("0")
                                        ),
                                    !l.hasValue() &&
                                        l.setValue(
                                            t.getAttribute("y").getValue("0")
                                        ),
                                    !o.hasValue() &&
                                        o.setValue(
                                            t.getAttribute("dx").getValue("0")
                                        ),
                                    !s.hasValue() &&
                                        s.setValue(
                                            t.getAttribute("dy").getValue("0")
                                        )),
                                i.hasValue())
                            ) {
                                if (
                                ...
                                o.hasValue() && (t.x += o.getPixels("x")),
                                    (r.x = t.x);
                            }
                            return (
                                (t.x = r.x + r.measureText(e)),
                                l.hasValue()
                                    ? ((r.y = l.getPixels("y")),
                                      s.hasValue() && (r.y += s.getPixels("y")))
                                    : (s.hasValue() &&
                                          (t.y += s.getPixels("y")),
                                      (r.y = t.y)),
                                (t.y = r.y),
                    ...
                    },
                    {
                        ...
                        value: function (e, t, n, a) {
                            ...
                            return l
                                ? (r.children.forEach(function (n, a) {
                                ...
                                for (
                                    var r = this.getFontSize(),
                                        l = a.isRTL
                                            ...
                                            : t,
                                        s = o(n.getAttribute("dx").getString()),
                                        d = l.length,
                                        u = 0,
                                        g = 0,
                                        c;
                                    ...
                                    (c = this.getGlyph(a, l, g)),
                                        (u +=
                                            ((c.horizAdvX || a.horizAdvX) * r) /
                                            a.fontFace.unitsPerEm),
                                        "undefined" == typeof s[g] ||
                                            isNaN(s[g]) ||
                                            (u += s[g]);
                                return u;
                            }
        ...
        Ld = (function (e) {
            function t(e, n, a) {
                ...
                return (
                    ...
                    (r.type = "tspan"),
                    (r.text = 0 < r.children.length ? "" : r.getTextFromNode()),
                    r
                );
            }
            return (
            ...
            fill: function (e) {
                for (
                    var t = ln(this),
                        n = Dt(t.length),
                        a = arguments.length,
                        r = Nt(1 < a ? arguments[1] : void 0, n),
                        i = 2 < a ? arguments[2] : void 0,
                        l = void 0 === i ? n : Nt(i, n);
                    l > r;
                ...
                qr(e, [
                    {
                        ...
                        value: function () {
                            (this.i = -1),
                                (this.command = ""),
                                (this.previousCommand = ""),
                                (this.start = new qo(0, 0)),
                                (this.control = new qo(0, 0)),
                                (this.current = new qo(0, 0)),
                                (this.points = []),
                                (this.angles = []);
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (e, t, n) {
                            ...
                            n &&
                                0 < r.length &&
                                !r[r.length - 1] &&
                                (r[r.length - 1] = a[a.length - 1].angleTo(n)),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            for (
                                var e = this.angles, t = e.length, n = 0;
                                n < t;
                                n++
                            )
                                if (!e[n])
        ...
        Nd = (function (e) {
            function t(e, n, a) {
                ...
                return (
                    ...
                    (r.type = "path"),
                    (r.pathParser = null),
                    (r.pathParser = new Dd(r.getAttribute("d").getString())),
                    r
                );
            }
            return (
                ...
                qr(t, [
                    {
                        ...
                        value: function (e) {
                            ...
                            for (t.reset(), e && e.beginPath(); !t.isEnd(); )
                                switch ((t.nextCommand(), t.command)) {
                                    case "M":
                                    case "m":
                                        this.pathM(e, n);
                                        break;
                        ...
                        value: function (e, t) {
                            for (
                                ...
                                n.addMarker(i, r, r),
                                    ...
                                    e && e.quadraticCurveTo(r.x, r.y, i.x, i.y);
                            }
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            for (
                                ...
                                if (
                                    (n.addMarkerAngle(E, A - (P * ye) / 2),
                                    n.addMarkerAngle(p, A - P * ye),
                                    t.addPoint(p.x, p.y),
                                    e && !isNaN(k) && !isNaN(v))
                                ) {
                                    var T = i > o ? i : o,
                        ...
                        value: function (e) {
                            ...
                            if (
                                ...
                                i.style &&
                                    "undefined" != typeof e.font &&
                                    r &&
                                    "undefined" != typeof r.getComputedStyle)
                            ) {
                                e.font = r
                                    .getComputedStyle(i)
                                ...
                                var l = new Uo(
                                    n,
                                    "fontSize",
                                    ed.parse(e.font).fontSize
                                );
                                l.hasValue() &&
                                    ((n.rootEmSize = l.getPixels("y")),
                            ...
                            this.getStyle("width").hasValue() ||
                                ...
                                this.getStyle("height").hasValue() ||
                                    this.getStyle("height", !0).setValue(
                                        "100%"
                                    );
                            ...
                            y && ((f = y[0]), (m = y[1])),
                                this.root ||
                                    ((d =
                                        this.getStyle("width").getPixels("x")),
                                    (u =
                                        this.getStyle("height").getPixels("y")),
                                    "marker" === this.type &&
                                        ((x = f), (b = m), (f = 0), (m = 0))),
                                a.viewPort.setCurrent(d, u),
                                y && ((d = y[2]), (u = y[3])),
                                n.setViewBox({
                                    ctx: e,
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (
                                ...
                                u.hasValue() && u.setValue("".concat(e, "px")),
                                    g.hasValue() &&
                                        g.setValue("".concat(t, "px"));
                            }
                        },
                    },
                ]),
                ...
                qr(t, [
                    {
                        ...
                        value: function (e) {
                            var t = this.getAttribute("x").getPixels("x"),
                                ...
                                s = l.getPixels("y");
                            if (
                                (i.hasValue() && !l.hasValue() && (s = o),
                                l.hasValue() && !i.hasValue() && (o = s),
                                (o = xe(o, a / 2)),
                                (s = xe(s, r / 2)),
                                e)
                            ) {
                        ...
                        value: function (e) {
                            ...
                            return (
                                e &&
                                    0 < a &&
                                    (e.beginPath(),
                                    e.arc(t, n, a, 0, 2 * ye, !1),
                                    e.closePath()),
                                new fd(t - a, n - a, t + a, n + a)
                            );
                        },
                    },
                    {
        ...
        jd = (function (e) {
            function t(e, n, a) {
                ...
                return (
                    ...
                    (r.type = "polyline"),
                    (r.points = []),
                    (r.points = qo.parsePath(
                        r.getAttribute("points").getString()
                    )),
                    r
                );
            }
                ...
                qr(t, [
                    {
                        key: "path",
                        value: function (e) {
                            var n = Js(is(t.prototype), "path", this).call(
                                    this,
                                    e
                                ),
                                a = xa(this.points, 1),
    ...
    var Yd = (function (e) {
                ...
                qr(t, [
                    {
                        ...
                        value: function (e, t, n) {
                            ...
                            (i.attributes.viewBox = new Uo(
                                this.document,
                                "viewBox",
                                this.getAttribute("viewBox").getValue()
                            )),
                                (i.attributes.width = new Uo(
                                    this.document,
                                    "width",
                                    "".concat(a, "px")
                                )),
                                (i.attributes.height = new Uo(
                                    this.document,
                                    "height",
                                    "".concat(r, "px")
                                )),
                                (i.attributes.transform = new Uo(
                                    this.document,
                                    "transform",
                                    this.getAttribute(
                                        "patternTransform"
                            ...
                            for (var u = -1; 1 >= u; u++)
                                for (var g = -1; 1 >= g; g++)
                                    o.save(),
                                        (i.attributes.x = new Uo(
                                            this.document,
                                            "x",
                                            u * l.width
                                        )),
                                        (i.attributes.y = new Uo(
                                            this.document,
                                            "y",
                                            g * l.height
                                        )),
                ...
                qr(t, [
                    {
                        ...
                        value: function (e, t, n) {
                            if (t) {
                                ...
                                (o.type = this.type),
                                    (o.attributes.viewBox = new Uo(
                                        this.document,
                                        "viewBox",
                                        this.getAttribute("viewBox").getValue()
                                    )),
                                    (o.attributes.refX = new Uo(
                                        this.document,
                                        "refX",
                                        this.getAttribute("refX").getValue()
                                    )),
                                    (o.attributes.refY = new Uo(
                                        this.document,
                                        "refY",
                                        this.getAttribute("refY").getValue()
                                    )),
                                    (o.attributes.width = new Uo(
                                        this.document,
                                        "width",
                                        this.getAttribute(
                                            "markerWidth"
                                    ...
                                    (o.attributes.overflow = new Uo(
                                        this.document,
                                        "overflow",
                                        this.getAttribute("overflow").getValue()
                                    )),
                                    (o.attributes.fill = new Uo(
                                        this.document,
                                        "fill",
                                        this.getAttribute("fill").getValue(
                                            "black"
                                        )
                                    )),
                                    (o.attributes.stroke = new Uo(
                                        this.document,
                                        "stroke",
                                        this.getAttribute("stroke").getValue(
                                            "none"
                                        )
                                    )),
        ...
        Ud = (function (e) {
            ...
            return (
                os(t, e), qr(t, [{ key: "render", value: function () {} }]), t
            );
        })(Ys),
        Wd = (function (e) {
            function t() {
        ...
        qd = (function (e) {
            function t(e, n, a) {
                ...
                Wr(this, t),
                    (r = rs(this, is(t).call(this, e, n, a))),
                    (r.attributesToInherit = ["gradientUnits"]),
                    (r.stops = []);
                var i = as(r),
                    l = i.stops,
                    o = i.children;
                        ...
                        value: function (e, t, n) {
                            ...
                            if (
                                ...
                                var s = this.document,
                                    ...
                                    p = c[0],
                                    y = new zd(s, null);
                                (y.attributes.x = new Uo(s, "x", -u / 3)),
                                    (y.attributes.y = new Uo(s, "y", -u / 3)),
                                    (y.attributes.width = new Uo(
                                        s,
                                        "width",
                                        u
                                    )),
                                    (y.attributes.height = new Uo(
                                        s,
                                        "height",
                                        u
                                    ));
                                var h = new Wd(s, null);
                                (h.attributes.transform = new Uo(
                                    s,
                                    "transform",
                                    this.getAttribute(
                                        "gradientTransform"
                                    ...
                                    (h.children = [y]);
                                var f = new Md(s, null);
                                (f.attributes.x = new Uo(s, "x", 0)),
                                    (f.attributes.y = new Uo(s, "y", 0)),
                                    (f.attributes.width = new Uo(
                                        s,
                                        "width",
                                        p.width
                                    )),
                                    (f.attributes.height = new Uo(
                                        s,
                                        "height",
                                        p.height
                                    )),
                        ...
                        value: function (e) {
                            ...
                            this.attributesToInherit.forEach(function (n) {
                                !t.getAttribute(n).hasValue() &&
                                    ...
                                    t
                                        .getAttribute(n, !0)
                                        .setValue(e.getAttribute(n).getValue());
                            });
                        },
                    },
                    {
        ...
        Xd = (function (e) {
            function t(e, n, a) {
                ...
                return (
                    ...
                    r.attributesToInherit.push("x1", "y1", "x2", "y2"),
                    r
                );
            }
            return (
                ...
                qr(t, [
                    {
                        ...
                        value: function (e, t) {
                            ...
                            var r = n
                                    ? a.x +
                                      a.width *
                                          this.getAttribute("x1").getNumber()
                                    : this.getAttribute("x1").getPixels("x"),
                                i = n
                                    ? a.y +
                                      a.height *
                                          this.getAttribute("y1").getNumber()
                                    : this.getAttribute("y1").getPixels("y"),
                                l = n
                                    ? a.x +
                                      a.width *
                                          this.getAttribute("x2").getNumber()
                                    : this.getAttribute("x2").getPixels("x"),
                                o = n
                                    ? a.y +
                                      a.height *
                                          this.getAttribute("y2").getNumber()
                                    : this.getAttribute("y2").getPixels("y");
                            return r === l && i === o
                                ? null
                                : e.createLinearGradient(r, i, l, o);
                        },
                    },
                ]),
                t
                ...
                qr(t, [
                    {
                        ...
                        value: function (e, t) {
                            ...
                            var i = n
                                    ? a.x +
                                      a.width *
                                          this.getAttribute("cx").getNumber()
                                    : this.getAttribute("cx").getPixels("x"),
                                l = n
                                    ? a.y +
                                      a.height *
                                          this.getAttribute("cy").getNumber()
                            ...
                            this.getAttribute("fx").hasValue() &&
                                ...
                                this.getAttribute("fy").hasValue() &&
                                    (s = n
                                        ...
                                        : this.getAttribute("fy").getPixels(
                                              "y"
                                          ));
                            var d = n
                                    ? ((a.width + a.height) / 2) *
        ...
        tu = Bs(
            ...
            "Array",
            function (e, t) {
                Jd(this, { type: Zd, target: Fe(e), index: 0, kind: t });
            },
            function () {
                var e = eu(this),
                    t = e.target,
    ...
    var du = (function (e) {
            function t(e, n, a) {
                ...
                return (
                    ...
                    (r.removed = !1),
                    (r.frozen = !1),
                    e.screen.animations.push(as(r)),
                    (r.begin = r.getAttribute("begin").getMilliseconds()),
                    (r.maxDuration =
                        r.begin + r.getAttribute("dur").getMilliseconds()),
                    (r.from = r.getAttribute("from")),
                    (r.to = r.getAttribute("to")),
                    (r.values = r.getAttribute("values")),
                    r.values.hasValue() &&
                        r.values.setValue(r.values.getString().split(";")),
                    r
                );
            }
            return (
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this.initialUnits,
                                ...
                                i =
                                    a.getNumber() +
                                    (r.getNumber() - a.getNumber()) * n;
                            return (
                                "%" === e && (i *= 100), "".concat(i).concat(e)
                            );
                        },
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (
                                ...
                                var a =
                                    this.getAttribute("fill").getString(
                                        "remove"
                                    );
                                if (
                                    "indefinite" ===
                        ...
                        value: function () {
                            ...
                            if (t.hasValue()) {
                                ...
                                (n.from = new Uo(
                                    e,
                                    "from",
                                    parseFloat(t.getValue()[r])
                                )),
                                    (n.to = new Uo(
                                        e,
                                        "to",
                                        parseFloat(t.getValue()[i])
                                    )),
                                    (n.progress = (a - r) / (i - r));
        ...
        yu = pu
            ...
            : gu;
    nn({ global: !0, forced: parseInt != yu }, { parseInt: yu });
    var hu = (function (e) {
            function t() {
                var e;
                return (
    ...
    if (
        Oe &&
        "function" == typeof xu &&
        (!("description" in xu.prototype) || void 0 !== xu().description)
    ) {
        var bu = {},
            vu = function () {
                var e =
        ...
        mu(ku, "description", {
            ...
            nn({ global: !0, forced: !0 }, { Symbol: vu });
    }
    Xa("iterator");
    var Eu = (function (e) {
            function t(e, n, a) {
                ...
                Wr(this, t),
                    ...
                    (r.type = "font"),
                    (r.glyphs = {}),
                    (r.horizAdvX = r.getAttribute("horiz-adv-x").getNumber());
                var i = e.definitions,
                    l = as(r),
                    o = l.children,
                    s = !0,
                ...
                try {
                    for (
                        var g = o[Symbol.iterator](), c, p;
                        !(s = (c = g.next()).done);
                        s = !0
                    )
                        switch (((p = c.value), p.type)) {
                            case "font-face": {
                                r.fontFace = p;
                            ...
                            case "glyph": {
                                ...
                                h.arabicForm
                                    ? ((r.isRTL = !0),
                                      (r.isArabic = !0),
                                      "undefined" ==
                                          typeof r.glyphs[h.unicode] &&
                                          (r.glyphs[h.unicode] = {}),
                                      (r.glyphs[h.unicode][h.arabicForm] = h))
                                    : (r.glyphs[h.unicode] = h);
                                break;
                            }
                            default:
                        }
        ...
        Tu = (function (e) {
            function t(e, n, a) {
                ...
                return (
                    ...
                    (r = rs(this, is(t).call(this, e, n, a))),
                    (r.type = "font-face"),
                    (r.ascent = r.getAttribute("ascent").getNumber()),
                    (r.descent = r.getAttribute("descent").getNumber()),
                    (r.unitsPerEm = r.getAttribute("units-per-em").getNumber()),
                    r
                );
            }
            return os(t, e), t;
        ...
        wu = (function (e) {
            function t(e, n, a) {
                ...
                return (
                    ...
                    (r.type = "glyph"),
                    (r.horizAdvX = r.getAttribute("horiz-adv-x").getNumber()),
                    (r.unicode = r.getAttribute("unicode").getString()),
                    (r.arabicForm = r.getAttribute("arabic-form").getString()),
                    r
                );
            }
            return os(t, e), t;
        ...
        Vu = (function (e) {
            function t(e, n, a) {
                ...
                var i = n.childNodes,
                    ...
                    o =
                        0 < i.length &&
                        Array.from(i).every(function (e) {
                            return 3 === e.nodeType;
                        });
                return (
                    (r.hasText = o), (r.text = o ? r.getTextFromNode(l) : ""), r
                );
            }
            return (
                os(t, e),
        ...
        Lu = t(function (e) {
            var t = tt.f,
                ...
                i = function (e) {
                    t(e, n, { value: { objectID: "O" + ++a, weakData: {} } });
                },
                l = (e.exports = {
                    REQUIRED: !1,
        ...
        ju = (function (e, t, n) {
            ...
            if (
                ...
                y ||
                    ...
                    (s.prototype = o),
                    (o.constructor = s)),
                    (p || h) && (u("delete"), u("has"), a && u("get")),
                    (h || c) && u(i),
                    r && o.clear && delete o.clear;
            }
            return (
                (d[e] = s),
                nn({ global: !0, forced: s != l }, d),
                Za(s, e),
                r || n.setStrong(s, e, a),
                s
            );
        ...
        Gu = (function (e) {
            function t(e, n, a) {
                ...
                Wr(this, t),
                    ...
                    (r.pathLength = -1),
                    (r.glyphInfo = null),
                    (r.letterSpacingCache = []),
                    (r.measuresCache = new Map([["", 0]]));
                var i = r.getHrefAttribute().getDefinition();
                return (
                    (r.text = r.getTextFromNode()),
                    (r.dataArray = r.parsePathData(i)),
                    r
                );
            }
            return (
                ...
                qr(t, [
                        ...
                        value: function (e) {
                            ...
                            "underline" === t && e.beginPath(),
                                a.forEach(function (r, l) {
                                    ...
                                    e.save(),
                                        e.translate(i.x, i.y),
                                        e.rotate(a[l].rotation),
                                        e.fillStyle && e.fillText(s, 0, 0),
                                        e.strokeStyle && e.strokeText(s, 0, 0),
                                        e.restore(),
                                        "underline" === t &&
                                            (0 === l &&
                                                e.moveTo(i.x, i.y + n / 8),
                    ...
                    },
                    {
                        ...
                        value: function (e, t, n, a, r, i, l, o) {
                            ...
                            " " === l &&
                                ...
                                n < a &&
                                (d += (a - n) / r),
                                -1 < o && (s += this.getLetterSpacingAt(o));
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (!this.glyphInfo) {
                                ...
                                for (var y = 0; y < p; y++)
                                    c.push(
                                        "undefined" == typeof l[y] ? g : l[y]
                                    );
                                var h = c.reduce(function (e, t) {
                                    return e + t || 0;
                                }, 0);
                                (this.textWidth = this.measureText(e)),
                                    (this.textHeight = this.getFontSize());
                                var f = me(this.textWidth + h, 0);
                                this.glyphInfo = [];
                                var m = this.getPathLength(),
                                    x =
                                        this.getStyle("startOffset").getNumber(
                                            0
                                        ) * m,
                                    b = 0;
                                ("middle" === s || "center" === s) &&
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            for (
                                t.push(n.x, n.y), e.start = e.current;
                                !e.isCommandOrEnd();
                                    ...
                                    switch (u.command) {
                                        ...
                                        case "Q":
                                            (c = g / u.pathLength),
                                                1 < c && (c = 1),
                                                (a =
                                                    this.getPointOnQuadraticBezier(
                                                        c,
                                                        u.start.x,
                                                        u.start.y,
                                                        u.points[0],
        ...
        Uu = (function (e) {
            function t(e, n, r) {
                var i;
                Wr(this, t),
                    (i = rs(this, is(t).call(this, e, n, r))),
                    (i.type = "style");
                var l = a(
                                    ...
                                    if (
                                        (i.forEach(function (t) {
                                            var n = t.indexOf(":"),
                                                r = t.substr(0, n).trim(),
                                                i = t
                                                    .substr(n + 1, t.length - n)
                                                    .trim();
                                            r && i && (a[r] = new Uo(e, r, i));
                                        }),
                                        (e.styles[n] = a),
                                        (e.stylesSpecificity[n] = y(n)),
                                        "@font-face" === n)
                                    ) {
                                        var r = a["font-family"]
                                                .getString()
                ...
                qr(t, [
                    {
                        ...
                        value: function (e) {
                            ...
                            n.hasValue() && e.translate(n.getPixels("x"), 0),
                                a.hasValue() &&
                                    e.translate(0, a.getPixels("y"));
                        },
                    },
                    {
                        key: "path",
                            ...
                            if (n) {
                                ...
                                if (
                                    ("symbol" === n.type &&
                                        ...
                                        (a.children = n.children)),
                                    "svg" === a.type)
                                ) {
                                    var r = this.getStyle("width", !1, !0),
                                        i = this.getStyle("height", !1, !0);
                                    r.hasValue() &&
                                        (a.attributes.width = new Uo(
                                            t,
                                            "width",
                                            r.getString()
                                        )),
                                        i.hasValue() &&
                                            (a.attributes.height = new Uo(
                                                t,
                                                "height",
                                                i.getString()
                                            ));
            ...
            function t(e, n, r) {
                ...
                switch (i.getAttribute("type").getString("matrix")) {
                    ...
                    case "hueRotate": {
                        var s = (l[0] * ye) / 180;
                        l = [
                            m(s, 0.213, 0.787, -0.213),
                            m(s, 0.715, -0.715, -0.715),
                            m(s, 0.072, -0.072, 0.928),
                            0,
                            0,
                            m(s, 0.213, -0.213, 0.143),
                            m(s, 0.715, 0.285, 0.14),
                            m(s, 0.072, -0.072, -0.283),
                            0,
                            0,
                            m(s, 0.213, -0.213, -0.787),
                            m(s, 0.715, -0.715, 0.715),
                            m(s, 0.072, 0.928, 0.072),
                            0,
                            0,
                            0,
                            0,
                ...
                qr(t, [
                    {
                        ...
                        value: function (e, t, n, i, l) {
                            for (
                                var o = this.includeOpacity,
                                    s = this.matrix,
                                    d = e.getImageData(0, 0, i, l),
                                    u = 0;
                                u < l;
                                u++
                            )
                                for (var c = 0; c < i; c++) {
                                    var p = J(d.data, c, u, i, l, 0),
                                        ...
                                        b =
                                            ...
                                            te(s, 19, 1);
                                    o && ((a = f = m = 0), (b *= h / 255)),
                                        ee(d.data, c, u, i, l, 0, a),
                                        ee(d.data, c, u, i, l, 1, f),
                                        ee(d.data, c, u, i, l, 2, m),
                                        ee(d.data, c, u, i, l, 3, b);
                                }
                ...
                qr(t, [
                    {
                        ...
                        value: function (e, t) {
                            ...
                            var p = n.createCanvas(a + i, r + l),
                                c = p.getContext("2d");
                            n.screen.setDefaults(c),
                                t.render(c),
                                (c.globalCompositeOperation = "destination-in"),
                                (c.fillStyle = u.createPattern(d, "no-repeat")),
                                c.fillRect(0, 0, a + i, r + l),
                                (e.fillStyle = c.createPattern(p, "no-repeat")),
                                e.fillRect(0, 0, a + i, r + l),
                                t.getStyle("mask").setValue(s);
                        },
                    },
    ...
    nn(
        { target: "Reflect", stat: !0, forced: Zu },
        {
    ...
    var Ju = function () {},
                ...
                qr(t, [
                    {
                        ...
                        value: function (e) {
                            var t = this.document,
                                ...
                                a = e.beginPath,
                                r = e.closePath;
                            n && ((n.beginPath = Ju), (n.closePath = Ju)),
                                Reflect.apply(a, e, []),
                                this.children.forEach(function (a) {
                                    if ("undefined" != typeof a.path) {
                                        var i =
                                            "undefined" ==
                                            typeof a.elementTransform
                                                ? null
                                                : a.elementTransform();
                                        i || (i = Od.fromElement(t, a)),
                                            i && i.apply(e),
                                            a.path(e),
                                            n && (n.closePath = r),
                                            i && i.unapply(e);
                        ...
                        value: function (e, t) {
                            ...
                            if (a) {
                                ...
                                n.screen.setDefaults(c),
                                    ...
                                    t.getStyle("filter", !0).setValue(s);
                            }
                        },
                    },
                    { key: "render", value: function () {} },
        ...
        ng = (function (e) {
            ...
            return (
                os(t, e), qr(t, [{ key: "apply", value: function () {} }]), t
            );
        })(Ys),
        ag = (function (e) {
            function t() {
        ...
        sg = (function (e) {
            function t(e, n, a) {
                ...
                return (
                    Wr(this, t),
                    (r = rs(this, is(t).call(this, e, n, a))),
                    (r.type = "feGaussianBlur"),
                    (r.blurRadius = Se(
                        r.getAttribute("stdDeviation").getNumber()
                    )),
                    (r.extraFilterDistance = r.blurRadius),
                    r
                );
            }
            return (
        ...
        gg = (function () {
            function e(t) {
                ...
                Wr(this, e),
                    ...
                    (this.emSize = l),
                    (this.createCanvas = s),
                    (this.createImage = this.bindCreateImage(u, g)),
            ...
            return (
                qr(e, [
                    ...
                    },
                    {
                        key: "setViewBox",
                        value: function (e) {
                            this.screen.setViewBox(oe({ document: this }, e));
                        },
                    },
                    {
                        key: "window",
            ...
            function e(t, n) {
                var a =
                    2 < arguments.length && void 0 !== arguments[2]
                        ...
                        : {};
                Wr(this, e),
                    (this.parser = new ts(a)),
                    (this.screen = new Zo(t, a)),
                    (this.options = a);
                var r = new gg(this, a),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e =
                                    ...
                                    n = this.screen,
                                    a = this.options;
                                n.start(t, ge({ enableRedraw: !0 }, a, {}, e));
                            },
                        },
                        {
                            key: "stop",
    ...
    (e.AElement = Vu),
        (e.AnimateColorElement = hu),
        (e.AnimateElement = du),
        (e.AnimateTransformElement = fu),
        (e.BoundingBox = fd),
        (e.CB1 = v),
        (e.CB2 = k),
        (e.CB3 = S),
        ...
        (e.Canvg = cg),
        (e.CircleElement = Bd),
        (e.ClipPathElement = eg),
        (e.DefsElement = Ud),
        (e.DescElement = ug),
        (e.Document = gg),
        (e.Element = Ys),
        (e.EllipseElement = _d),
        (e.FeColorMatrixElement = qu),
        (e.FeCompositeElement = rg),
        (e.FeDropShadowElement = ng),
        (e.FeGaussianBlurElement = sg),
        (e.FeMorphologyElement = ag),
        (e.FilterElement = tg),
        (e.Font = ed),
        (e.FontElement = Eu),
        (e.FontFaceElement = Tu),
        (e.GElement = Wd),
        (e.GlyphElement = wu),
        (e.GradientElement = qd),
        (e.ImageElement = Hu),
        (e.LineElement = Fd),
        (e.LinearGradientElement = Xd),
        (e.MarkerElement = $d),
        (e.MaskElement = Xu),
        (e.Matrix = Ed),
        (e.MissingGlyphElement = Cu),
        (e.Mouse = Xo),
        (e.PSEUDO_ZERO = Ta),
        (e.Parser = ts),
        (e.PathElement = Nd),
        ...
        (e.Point = qo),
        (e.PolygonElement = Gd),
        (e.PolylineElement = jd),
        (e.Property = Uo),
        (e.QB1 = A),
        (e.QB2 = E),
        (e.QB3 = T),
        (e.RadialGradientElement = Qd),
        (e.RectElement = zd),
        (e.RenderedElement = Vd),
        (e.Rotate = Pd),
        (e.SVGElement = Md),
        (e.SVGFontLoader = $u),
        (e.Scale = Ad),
        ...
        (e.compressSpaces = a),
        (e.default = cg),
        (e.getSelectorSpecificity = y),
        (e.normalizeAttributeName = s),
        (e.parseExternalUrl = d),
        (e.presets = pg),
        (e.toNumbers = o),
        (e.trimLeft = r),
        (e.trimRight = l),
